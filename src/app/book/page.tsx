        ...
        <div className="max-w-7xl mx-auto px-6 py-16 lg:py-20">
          <div className="max-w-2xl">
            ...
            <p className="text-cream/70 text-lg leading-relaxed">
              ...
              No obligation to proceed with anything â just honest expertise
              about your skin.
            </p>
          </div>
        </div>
              ...
              {submitted ? (
                <div className="bg-cream p-10 lg:p-14 text-center">
                  ...
                  <p className="text-charcoal leading-relaxed mb-6">
                    We&rsquo;ve received your enquiry and a member of our team
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <select className="w-full px-4 py-3 bg-cream border border-warm-gray/50 text-charcoal text-sm focus:outline-none focus:border-gold transition-colors">
                      ...
                      <option>I look tired â volume loss, dullness, laxity</option>
                      <option>My skin has changed â pigmentation, melasma, rosacea</option>
                      <option>Lines and wrinkles</option>
                      <option>Body confidence â stubborn fat, skin tightening</option>
                      <option>Skin health check â moles, lesions</option>
                      <option>I know which treatment I want</option>
                      <option>I&rsquo;m not sure â I need guidance</option>
                    </select>
                  </div>
              ...
              <div className="bg-cream p-8">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    "Honest recommendation â or honest 'you don't need anything'",
                    "Written treatment plan to take home",
                    "No obligation to proceed",
                    "Â£30 fee redeemable against any treatment",
                  ].map((item) => (
